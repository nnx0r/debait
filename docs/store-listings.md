# DeBait — store listings

Localized title + full description for the Chrome Web Store and Firefox Add-ons
dashboards. Short manifest strings (name + 132-char description) live in
[../public/_locales](../public/_locales) and are generated from the same source
([../scripts/gen-i18n.mjs](../scripts/gen-i18n.mjs)). Edit the script, then run
`node scripts/gen-i18n.mjs` to regenerate both.

> 54 locales. Translations for less common locales are a starting
> point — have a native speaker review before submission.
...
DeBait – Real YouTube Thumbnails, Not Clickbait

**Short description** (122 chars)

Automatically replace clickbait YouTube thumbnails with the real first frame of the video. Lightweight, private, no setup.

**Description**

DeBait swaps clickbait YouTube thumbnails for the real first frame of each video, so your feed shows what videos are actually about — not the misleading bait.
...
DeBait – Miniaturas reales de YouTube, sin clickbait

**Short description** (119 chars)

Reemplaza las miniaturas clickbait de YouTube por el primer fotograma real del vídeo. Ligera, privada y sin configurar.

**Description**

DeBait cambia las miniaturas clickbait de YouTube por el primer fotograma real de cada vídeo, para que tu feed muestre de qué van realmente los vídeos y no el cebo engañoso.
...
Reemplaza las miniaturas clickbait de YouTube por el primer fotograma real del video. Ligera, privada y sin configurar.

**Description**

DeBait cambia las miniaturas clickbait de YouTube por el primer fotograma real de cada video, para que tu feed muestre de qué tratan realmente los videos y no el cebo engañoso.
...
DeBait – Miniaturas reais do YouTube, sem clickbait

**Short description** (129 chars)

Substitui automaticamente as miniaturas clickbait do YouTube pelo primeiro quadro real do vídeo. Leve, privada, sem configuração.

**Description**

O DeBait troca as miniaturas clickbait do YouTube pelo primeiro quadro real de cada vídeo, para o seu feed mostrar sobre o que os vídeos realmente são — e não a isca enganosa.
...
Substitui automaticamente as miniaturas clickbait do YouTube pela primeira imagem real do vídeo. Leve, privada, sem configuração.

**Description**

O DeBait troca as miniaturas clickbait do YouTube pela primeira imagem real de cada vídeo, para que o seu feed mostre aquilo de que os vídeos realmente tratam — e não o engodo.
...
DeBait – Vraies miniatures YouTube, sans clickbait

**Short description** (119 chars)

Remplace les miniatures clickbait de YouTube par la première image réelle de la vidéo. Légère, privée et sans réglages.

**Description**

DeBait remplace les miniatures clickbait de YouTube par la première image réelle de chaque vidéo, pour que votre fil montre de quoi parlent vraiment les vidéos — et non l'appât trompeur.
...
DeBait – Echte YouTube-Thumbnails statt Clickbait

**Short description** (125 chars)

Ersetzt Clickbait-Thumbnails auf YouTube automatisch durch das echte erste Bild des Videos. Leicht, privat, ohne Einrichtung.

**Description**

DeBait ersetzt Clickbait-Thumbnails auf YouTube durch das echte erste Bild jedes Videos, damit dein Feed zeigt, worum es wirklich geht — und nicht den irreführenden Köder.
...
DeBait – Miniature reali di YouTube, niente clickbait

**Short description** (126 chars)

Sostituisce le miniature clickbait di YouTube con il primo fotogramma reale del video. Leggera, privata, senza configurazione.

**Description**

DeBait sostituisce le miniature clickbait di YouTube con il primo fotogramma reale di ogni video, così il tuo feed mostra di cosa parlano davvero i video — e non l'esca ingannevole.
...
DeBait – Echte YouTube-thumbnails, geen clickbait

**Short description** (127 chars)

Vervangt clickbait-thumbnails op YouTube automatisch door het echte eerste beeld van de video. Licht, privé, geen instellingen.

**Description**

DeBait vervangt clickbait-thumbnails op YouTube door het echte eerste beeld van elke video, zodat je feed laat zien waar video's echt over gaan — niet het misleidende lokaas.
...
DeBait – Настоящие превью YouTube без кликбейта

**Short description** (115 chars)

Автоматически заменяет кликбейтные превью YouTube на настоящий первый кадр видео. Лёгкое, приватное, без настройки.

**Description**

DeBait заменяет кликбейтные превью YouTube на настоящий первый кадр каждого видео, чтобы лента показывала, о чём ролики на самом деле, а не вводящую в заблуждение приманку.
...
DeBait – Справжні прев’ю YouTube без клікбейту

**Short description** (111 chars)

Автоматично замінює клікбейтні прев’ю YouTube на справжній перший кадр відео. Легке, приватне, без налаштувань.

**Description**

DeBait замінює клікбейтні прев’ю YouTube на справжній перший кадр кожного відео, щоб ваша стрічка показувала, про що ролики насправді, а не оманливу принаду.
...
DeBait – Prawdziwe miniatury YouTube, bez clickbaitu

**Short description** (123 chars)

Automatycznie zastępuje clickbaitowe miniatury YouTube prawdziwą pierwszą klatką filmu. Lekkie, prywatne, bez konfiguracji.

**Description**

DeBait zamienia clickbaitowe miniatury YouTube na prawdziwą pierwszą klatkę każdego filmu, aby Twój feed pokazywał, o czym naprawdę są filmy — a nie mylącą przynętę.
...
DeBait – Skutečné náhledy YouTube, žádný clickbait

**Short description** (116 chars)

Automaticky nahrazuje clickbaitové náhledy YouTube skutečným prvním snímkem videa. Lehké, soukromé, bez nastavování.

**Description**

DeBait nahrazuje clickbaitové náhledy YouTube skutečným prvním snímkem každého videa, aby váš kanál ukazoval, o čem videa opravdu jsou — ne klamavou návnadu.
...
DeBait – Skutočné náhľady YouTube, žiadny clickbait

**Short description** (115 chars)

Automaticky nahrádza clickbaitové náhľady YouTube skutočným prvým snímkom videa. Ľahké, súkromné, bez nastavovania.

**Description**

DeBait nahrádza clickbaitové náhľady YouTube skutočným prvým snímkom každého videa, aby váš kanál ukazoval, o čom videá naozaj sú — nie klamlivú návnadu.
...
DeBait – Resnične sličice YouTube, brez klikvabe

**Short description** (104 chars)

Samodejno zamenja klikvabne sličice YouTube s pravo prvo sličico videa. Lahka, zasebna, brez nastavitev.

**Description**

DeBait zamenja klikvabne sličice YouTube s pravo prvo sličico vsakega videa, da vaš vir pokaže, o čem videi v resnici so — in ne zavajajoče vabe.
...
DeBait – Prave YouTube sličice, bez clickbaita

**Short description** (113 chars)

Automatski zamjenjuje clickbait sličice YouTubea pravom prvom sličicom videa. Lagano, privatno, bez postavljanja.

**Description**

DeBait zamjenjuje clickbait sličice YouTubea pravom prvom sličicom svakog videa, kako bi vaš feed pokazivao o čemu videi zaista jesu — a ne zavaravajući mamac.
...
DeBait – Праве YouTube сличице, без кликбејта

**Short description** (107 chars)

Аутоматски замењује кликбејт сличице YouTube-а правом првом сличицом видеа. Лако, приватно, без подешавања.

**Description**

DeBait замењује кликбејт сличице YouTube-а правом првом сличицом сваког видеа, да би ваш фид показивао о чему су видеи заиста — а не обмањујући мамац.
...
DeBait – Истински миниатюри в YouTube, без кликбейт

**Short description** (119 chars)

Автоматично заменя кликбейт миниатюрите в YouTube с истинския първи кадър на видеото. Леко, поверително, без настройки.

**Description**

DeBait заменя кликбейт миниатюрите в YouTube с истинския първи кадър на всяко видео, за да показва емисията ви за какво наистина са видеата — а не подвеждащата примамка.
...
DeBait – Miniaturi reale YouTube, fără clickbait

**Short description** (129 chars)

Înlocuiește automat miniaturile clickbait de pe YouTube cu primul cadru real al videoclipului. Ușoară, privată, fără configurare.

**Description**

DeBait înlocuiește miniaturile clickbait de pe YouTube cu primul cadru real al fiecărui videoclip, ca feedul tău să arate despre ce sunt cu adevărat videoclipurile — nu momeala înșelătoare.
...
DeBait – Valódi YouTube-bélyegképek kattintásvadászat nélkül

**Short description** (131 chars)

Automatikusan lecseréli a kattintásvadász YouTube-bélyegképeket a videó valódi első képkockájára. Könnyű, privát, beállítás nélkül.

**Description**

A DeBait lecseréli a kattintásvadász YouTube-bélyegképeket minden videó valódi első képkockájára, hogy a hírfolyamod azt mutassa, miről szólnak valójában a videók — nem a megtévesztő csalit.
...
DeBait – Πραγματικές μικρογραφίες YouTube, χωρίς clickbait

**Short description** (126 chars)

Αντικαθιστά τις clickbait μικρογραφίες του YouTube με το πραγματικό πρώτο καρέ του βίντεο. Ελαφριά, ιδιωτική, χωρίς ρυθμίσεις.

**Description**

Το DeBait αντικαθιστά τις clickbait μικρογραφίες του YouTube με το πραγματικό πρώτο καρέ κάθε βίντεο, ώστε η ροή σας να δείχνει για τι πραγματικά είναι τα βίντεο — όχι το παραπλανητικό δόλωμα.
...
DeBait – Gerçek YouTube küçük resimleri, tıklama tuzağı yok

**Short description** (128 chars)

YouTube’daki tıklama tuzağı küçük resimleri otomatik olarak videonun gerçek ilk karesiyle değiştirir. Hafif, gizli, kurulum yok.

**Description**

DeBait, YouTube’un tıklama tuzağı küçük resimlerini her videonun gerçek ilk karesiyle değiştirir; böylece akışınız videoların gerçekte ne hakkında olduğunu gösterir — yanıltıcı yemi değil.
...
DeBait – Aidot YouTube-pikkukuvat, ei klikkiotsikoita

**Short description** (126 chars)

Korvaa klikkiansapikkukuvat YouTubessa automaattisesti videon aidolla ensimmäisellä ruudulla. Kevyt, yksityinen, ei asetuksia.

**Description**

DeBait korvaa YouTuben klikkiansapikkukuvat jokaisen videon aidolla ensimmäisellä ruudulla, jotta syötteesi näyttää, mistä videot oikeasti kertovat — eikä harhaanjohtavaa syöttiä.
...
DeBait – Äkta YouTube-miniatyrer, inget clickbait

**Short description** (121 chars)

Ersätter automatiskt clickbait-miniatyrer på YouTube med videons äkta första bildruta. Lätt, privat, ingen konfiguration.

**Description**

DeBait byter ut clickbait-miniatyrer på YouTube mot den äkta första bildrutan i varje video, så att ditt flöde visar vad videorna faktiskt handlar om — inte det vilseledande betet.
...
DeBait – Ægte YouTube-miniaturer, intet clickbait

**Short description** (116 chars)

Erstatter automatisk clickbait-miniaturer på YouTube med videoens ægte første billede. Let, privat, ingen opsætning.

**Description**

DeBait erstatter clickbait-miniaturer på YouTube med det ægte første billede af hver video, så dit feed viser, hvad videoerne faktisk handler om — ikke det vildledende lokkemiddel.
...
DeBait – Ekte YouTube-miniatyrer, ingen clickbait

**Short description** (113 chars)

Erstatter automatisk clickbait-miniatyrer på YouTube med videoens ekte første bilde. Lett, privat, ingen oppsett.

**Description**

DeBait erstatter clickbait-miniatyrer på YouTube med det ekte første bildet av hver video, slik at strømmen din viser hva videoene faktisk handler om — ikke det villedende agnet.
...
DeBait – Tõelised YouTube’i pisipildid, ilma clickbait’ita

**Short description** (115 chars)

Asendab YouTube’i clickbait-pisipildid automaatselt video tõelise esimese kaadriga. Kerge, privaatne, seadistuseta.

**Description**

DeBait asendab YouTube’i clickbait-pisipildid iga video tõelise esimese kaadriga, et su voog näitaks, millest videod tegelikult räägivad — mitte eksitavat sööta.
...
DeBait – Tikros „YouTube“ miniatiūros, jokio spustelėjimų jauko

**Short description** (128 chars)

Automatiškai pakeičia „YouTube“ spustelėjimų jauko miniatiūras tikru pirmuoju vaizdo įrašo kadru. Lengva, privatu, be nustatymų.

**Description**

„DeBait“ pakeičia „YouTube“ spustelėjimų jauko miniatiūras tikru pirmuoju kiekvieno vaizdo įrašo kadru, kad jūsų sraute matytumėte, apie ką iš tikrųjų yra įrašai — o ne klaidinantį jauką.
...
DeBait – Īsti YouTube sīktēli, bez clickbait

**Short description** (111 chars)

Automātiski aizstāj YouTube clickbait sīktēlus ar video patieso pirmo kadru. Viegls, privāts, bez iestatīšanas.

**Description**

DeBait aizstāj YouTube clickbait sīktēlus ar katra video patieso pirmo kadru, lai tava plūsma rāda, par ko video patiešām ir — nevis maldinošo ēsmu.
...
DeBait – Miniatures reals de YouTube, sense clickbait

**Short description** (123 chars)

Substitueix les miniatures clickbait de YouTube pel primer fotograma real del vídeo. Lleugera, privada, sense configuració.

**Description**

DeBait substitueix les miniatures clickbait de YouTube pel primer fotograma real de cada vídeo, perquè el teu feed mostri de què van realment els vídeos — i no l'esquer enganyós.
...
DeBait – صور يوتيوب المصغّرة الحقيقية بلا نقر مخادع

**Short description** (94 chars)

يستبدل تلقائيًا صور يوتيوب المصغّرة المخادعة بأول إطار حقيقي من الفيديو. خفيف وخاص وبلا إعداد.

**Description**

يستبدل DeBait صور يوتيوب المصغّرة المخادعة بأول إطار حقيقي من كل فيديو، حتى يعرض موجزك ما تدور حوله مقاطع الفيديو فعليًا — لا الطُّعم المضلِّل.
...
DeBait – תמונות ממוזערות אמיתיות ביוטיוב, בלי קליקבייט

**Short description** (101 chars)

מחליף אוטומטית תמונות ממוזערות קליקבייט ביוטיוב בפריים הראשון האמיתי של הסרטון. קל, פרטי, ללא הגדרות.

**Description**

‏DeBait מחליף את התמונות הממוזערות מסוג קליקבייט ביוטיוב בפריים הראשון האמיתי של כל סרטון, כדי שהפיד שלך יראה במה הסרטונים באמת עוסקים — ולא את הפיתיון המטעה.
...
DeBait – تصاویر بندانگشتی واقعی یوتیوب، بدون کلیک‌بیت

**Short description** (118 chars)

تصاویر بندانگشتی کلیک‌بیت یوتیوب را به‌طور خودکار با نخستین فریم واقعی ویدیو جایگزین می‌کند. سبک، خصوصی، بدون تنظیمات.

**Description**

‏DeBait تصاویر بندانگشتی کلیک‌بیت یوتیوب را با نخستین فریم واقعی هر ویدیو جایگزین می‌کند تا فید شما نشان دهد ویدیوها واقعاً دربارهٔ چه هستند — نه طعمهٔ گمراه‌کننده.
...
DeBait – असली YouTube थंबनेल, कोई क्लिकबेट नहीं

**Short description** (105 chars)

YouTube के क्लिकबेट थंबनेल को अपने आप वीडियो के असली पहले फ़्रेम से बदल देता है। हल्का, निजी, बिना सेटअप।

**Description**

DeBait YouTube के क्लिकबेट थंबनेल को हर वीडियो के असली पहले फ़्रेम से बदल देता है, ताकि आपका फ़ीड दिखाए कि वीडियो असल में किस बारे में हैं — भ्रामक चारा नहीं।
...
DeBait – আসল YouTube থাম্বনেল, কোনো ক্লিকবেট নয়

**Short description** (117 chars)

YouTube-এর ক্লিকবেট থাম্বনেল স্বয়ংক্রিয়ভাবে ভিডিওর আসল প্রথম ফ্রেম দিয়ে বদলে দেয়। হালকা, ব্যক্তিগত, সেটআপ ছাড়াই।

**Description**

DeBait YouTube-এর ক্লিকবেট থাম্বনেলকে প্রতিটি ভিডিওর আসল প্রথম ফ্রেম দিয়ে বদলে দেয়, যাতে আপনার ফিড দেখায় ভিডিওগুলো আসলে কী নিয়ে — বিভ্রান্তিকর টোপ নয়।
...
DeBait – અસલી YouTube થંબનેલ, કોઈ ક્લિકબેટ નહીં

**Short description** (97 chars)

YouTube ના ક્લિકબેટ થંબનેલને આપમેળે વિડિયોના અસલી પ્રથમ ફ્રેમથી બદલે છે. હલકું, ખાનગી, સેટઅપ વગર.

**Description**

DeBait YouTube ના ક્લિકબેટ થંબનેલને દરેક વિડિયોના અસલી પ્રથમ ફ્રેમથી બદલે છે, જેથી તમારું ફીડ બતાવે કે વિડિયો ખરેખર શેના વિશે છે — ભ્રામક લાલચ નહીં.
...
DeBait – ನಿಜವಾದ YouTube ಥಂಬ್‌ನೇಲ್‌ಗಳು, ಕ್ಲಿಕ್‌ಬೈಟ್ ಇಲ್ಲ

**Short description** (125 chars)

YouTube ನ ಕ್ಲಿಕ್‌ಬೈಟ್ ಥಂಬ್‌ನೇಲ್‌ಗಳನ್ನು ವೀಡಿಯೊದ ನಿಜವಾದ ಮೊದಲ ಫ್ರೇಮ್‌ನಿಂದ ಸ್ವಯಂಚಾಲಿತವಾಗಿ ಬದಲಾಯಿಸುತ್ತದೆ. ಹಗುರ, ಖಾಸಗಿ, ಸೆಟಪ್ ಇಲ್ಲ.

**Description**

DeBait YouTube ನ ಕ್ಲಿಕ್‌ಬೈಟ್ ಥಂಬ್‌ನೇಲ್‌ಗಳನ್ನು ಪ್ರತಿ ವೀಡಿಯೊದ ನಿಜವಾದ ಮೊದಲ ಫ್ರೇಮ್‌ನಿಂದ ಬದಲಾಯಿಸುತ್ತದೆ, ಇದರಿಂದ ನಿಮ್ಮ ಫೀಡ್ ವೀಡಿಯೊಗಳು ನಿಜವಾಗಿ ಯಾವುದರ ಕುರಿತು ಎಂದು ತೋರಿಸುತ್ತದೆ — ದಾರಿತಪ್ಪಿಸುವ ಆಮಿಷವಲ್ಲ.
...
DeBait – യഥാർത്ഥ YouTube തംബ്നെയിലുകൾ, ക്ലിക്ക്ബെയ്റ്റ് ഇല്ല

**Short description** (130 chars)

YouTube-ന്റെ ക്ലിക്ക്ബെയ്റ്റ് തംബ്നെയിലുകൾ വീഡിയോയുടെ യഥാർത്ഥ ആദ്യ ഫ്രെയിം കൊണ്ട് സ്വയം മാറ്റുന്നു. ലഘു, സ്വകാര്യം, സജ്ജീകരണമില്ല.

**Description**

DeBait YouTube-ന്റെ ക്ലിക്ക്ബെയ്റ്റ് തംബ്നെയിലുകൾ ഓരോ വീഡിയോയുടെയും യഥാർത്ഥ ആദ്യ ഫ്രെയിം കൊണ്ട് മാറ്റുന്നു, അങ്ങനെ വീഡിയോകൾ യഥാർത്ഥത്തിൽ എന്തിനെക്കുറിച്ചാണെന്ന് നിങ്ങളുടെ ഫീഡ് കാണിക്കും — തെറ്റിദ്ധരിപ്പിക്കുന്ന ചൂണ്ടയല്ല.
...
DeBait – खरे YouTube थंबनेल, क्लिकबेट नाही

**Short description** (98 chars)

YouTube चे क्लिकबेट थंबनेल आपोआप व्हिडिओच्या खऱ्या पहिल्या फ्रेमने बदलते. हलके, खाजगी, सेटअपशिवाय.

**Description**

DeBait YouTube चे क्लिकबेट थंबनेल प्रत्येक व्हिडिओच्या खऱ्या पहिल्या फ्रेमने बदलते, जेणेकरून तुमचा फीड व्हिडिओ खरोखर कशाबद्दल आहेत हे दाखवेल — दिशाभूल करणारे आमिष नाही.
...
DeBait – உண்மையான YouTube சிறுபடங்கள், கிளிக்பெய்ட் இல்லை

**Short description** (129 chars)

YouTube இன் கிளிக்பெய்ட் சிறுபடங்களை வீடியோவின் உண்மையான முதல் ஃபிரேமால் மாற்றுகிறது. இலகுவானது, தனிப்பட்டது, அமைப்பு தேவையில்லை.

**Description**

DeBait YouTube இன் கிளிக்பெய்ட் சிறுபடங்களை ஒவ்வொரு வீடியோவின் உண்மையான முதல் ஃபிரேமால் மாற்றுகிறது, இதனால் வீடியோக்கள் உண்மையில் எதைப் பற்றியவை என்பதை உங்கள் ஃபீட் காட்டும் — தவறாக வழிநடத்தும் தூண்டில் அல்ல.
...
DeBait – అసలైన YouTube థంబ్‌నెయిల్‌లు, క్లిక్‌బెయిట్ లేదు

**Short description** (131 chars)

YouTube క్లిక్‌బెయిట్ థంబ్‌నెయిల్‌లను వీడియో అసలైన మొదటి ఫ్రేమ్‌తో ఆటోమేటిక్‌గా మారుస్తుంది. తేలికైనది, ప్రైవేట్, సెటప్ అవసరం లేదు.

**Description**

DeBait YouTube క్లిక్‌బెయిట్ థంబ్‌నెయిల్‌లను ప్రతి వీడియో అసలైన మొదటి ఫ్రేమ్‌తో మారుస్తుంది, తద్వారా వీడియోలు నిజంగా దేని గురించి అన్నది మీ ఫీడ్ చూపిస్తుంది — తప్పుదారి పట్టించే ఎరను కాదు.
...
DeBait – እውነተኛ የYouTube ድንክዬዎች፣ ያለ ጠቅታ ማታለያ

**Short description** (80 chars)

የYouTube ጠቅታ ማታለያ ድንክዬዎችን በቪዲዮው እውነተኛ የመጀመሪያ ፍሬም በራስ-ሰር ይተካል። ቀላል፣ ግላዊ፣ ያለ ማዋቀር።

**Description**

DeBait የYouTube ጠቅታ ማታለያ ድንክዬዎችን በእያንዳንዱ ቪዲዮ እውነተኛ የመጀመሪያ ፍሬም ይተካል፣ ስለዚህ ፊድዎ ቪዲዮዎቹ በእውነቱ ስለ ምን እንደሆኑ ያሳያል — የሚያሳስት ማጥመጃ አይደለም።
...
DeBait – Vijipicha halisi vya YouTube, bila clickbait

**Short description** (127 chars)

Hubadilisha kiotomatiki vijipicha vya clickbait vya YouTube na fremu halisi ya kwanza ya video. Nyepesi, faragha, bila usanidi.

**Description**

DeBait hubadilisha vijipicha vya clickbait vya YouTube na fremu halisi ya kwanza ya kila video, ili mlisho wako uonyeshe video zinahusu nini hasa — si chambo cha kupotosha.
...
DeBait – ภาพขนาดย่อ YouTube ของจริง ไม่มีคลิกเบต

**Short description** (101 chars)

แทนที่ภาพขนาดย่อคลิกเบตบน YouTube ด้วยเฟรมแรกจริงของวิดีโอโดยอัตโนมัติ เบา เป็นส่วนตัว ไม่ต้องตั้งค่า

**Description**

DeBait แทนที่ภาพขนาดย่อคลิกเบตบน YouTube ด้วยเฟรมแรกจริงของแต่ละวิดีโอ เพื่อให้ฟีดของคุณแสดงว่าวิดีโอเกี่ยวกับอะไรจริง ๆ ไม่ใช่เหยื่อล่อที่ทำให้เข้าใจผิด
...
DeBait – Hình thu nhỏ YouTube thật, không câu khách

**Short description** (125 chars)

Tự động thay hình thu nhỏ câu khách trên YouTube bằng khung hình đầu tiên thật của video. Nhẹ, riêng tư, không cần thiết lập.

**Description**

DeBait thay hình thu nhỏ câu khách trên YouTube bằng khung hình đầu tiên thật của mỗi video, để bảng tin của bạn cho thấy video thực sự nói về điều gì — không phải mồi nhử gây hiểu lầm.
...
DeBait – Thumbnail YouTube asli, bukan umpan klik

**Short description** (114 chars)

Otomatis mengganti thumbnail umpan klik YouTube dengan frame pertama asli video. Ringan, privat, tanpa pengaturan.

**Description**

DeBait mengganti thumbnail umpan klik YouTube dengan frame pertama asli setiap video, sehingga feed Anda menampilkan isi video yang sebenarnya — bukan umpan yang menyesatkan.
...
DeBait – Lakaran kecil YouTube sebenar, tiada umpan klik

**Short description** (119 chars)

Menggantikan lakaran kecil umpan klik YouTube dengan bingkai pertama sebenar video. Ringan, peribadi, tiada persediaan.

**Description**

DeBait menggantikan lakaran kecil umpan klik YouTube dengan bingkai pertama sebenar setiap video, supaya suapan anda menunjukkan kandungan sebenar video — bukan umpan yang mengelirukan.
...
DeBait – Tunay na thumbnail sa YouTube, walang clickbait

**Short description** (127 chars)

Awtomatikong pinapalitan ang clickbait na thumbnail sa YouTube ng tunay na unang frame ng video. Magaan, pribado, walang setup.

**Description**

Pinapalitan ng DeBait ang clickbait na thumbnail sa YouTube ng tunay na unang frame ng bawat video, para ipakita ng iyong feed kung tungkol saan talaga ang mga video — hindi ang nakakalinlang na pain.
...
DeBait – 本物のYouTubeサムネイル、釣りサムネなし

**Short description** (53 chars)

YouTubeの釣りサムネを動画の本物の最初のフレームに自動で置き換えます。軽量・プライベート・設定不要。

**Description**

DeBaitはYouTubeの釣りサムネイルを各動画の本物の最初のフレームに置き換え、フィードに動画の実際の内容を表示します。誤解を招く「釣り」ではありません。
...
DeBait – 진짜 유튜브 썸네일, 낚시성 썸네일 제거

**Short description** (63 chars)

유튜브의 낚시성 썸네일을 영상의 진짜 첫 프레임으로 자동 교체합니다. 가볍고, 비공개이며, 설정이 필요 없습니다.

**Description**

DeBait는 유튜브의 낚시성 썸네일을 각 영상의 진짜 첫 프레임으로 바꿔, 피드가 영상의 실제 내용을 보여 주도록 합니다 — 오해를 부르는 미끼가 아니라요.
...
DeBait – 真实的 YouTube 缩略图，告别标题党

**Short description** (42 chars)

自动将 YouTube 的标题党缩略图替换为视频真实的第一帧。轻量、隐私、无需设置。

**Description**

DeBait 将 YouTube 的标题党缩略图替换为每个视频真实的第一帧，让你的信息流呈现视频的真实内容，而不是误导性的诱饵。
...
DeBait – 真實的 YouTube 縮圖，拒絕標題黨

**Short description** (42 chars)

自動將 YouTube 的標題黨縮圖替換成影片真實的第一個影格。輕量、隱私、免設定。

**Description**

DeBait 將 YouTube 的標題黨縮圖替換成每部影片真實的第一個影格，讓你的動態顯示影片真正的內容，而不是誤導人的誘餌。
